...
@protocol KalViewControlleDelegate<NSObject>

- (void)didSelectDate:(NSDate *)date;
@optional
-(void)showPreviousMonthDownFrom:(NSDate *)startDate to:(NSDate *)endDate;
-(void)showFollowingMonthUpFrom:(NSDate *)startDate to:(NSDate *)endDate;
-(void)showPreviousMonthRightFrom:(NSDate *)startDate to:(NSDate *)endDate;
-(void)showFollowingMonthLeftFrom:(NSDate *)startDate to:(NSDate *)endDate;
...
@interface KalViewController : UIViewController <KalViewDelegate, KalDataSourceCallbacks>
{
  ...
  id<KalViewControlleDelegate> viewDelegate;
...
@property (nonatomic, assign) id<KalViewControlleDelegate> viewDelegate;;
