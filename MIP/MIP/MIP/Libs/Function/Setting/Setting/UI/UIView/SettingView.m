...
- (void)updateNewVersion:(id)sender
{
    ...
    if (isValid(updateURL)) {
        ...
        NSLog(@"----------------%f   %@",[[UIDevice currentDevice].systemVersion floatValue],updateURL);
        
        if ([[UIDevice currentDevice].systemVersion floatValue] > 7.090000)
        {
