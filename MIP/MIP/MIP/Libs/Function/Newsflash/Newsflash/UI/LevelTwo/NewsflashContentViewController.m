...
@interface NewsflashContentViewController (){
    MBProgressHUD   *_HUD;
}

@end

@implementation NewsflashContentViewController
@synthesize backBtn;
...
- (void)viewDidLoad
{
    ...
    if ([[[UIDevice currentDevice] systemVersion] floatValue]>=7.0) {
        ...
        titleLabel.frame = CGRectMake(90, 20, self.view.frame.size.width - 90, 54);
